...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'controlplane', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-controlplane',
    version=ABOUT['__version__'],
    description='The ControlPlane check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent controlplane check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Control Plane',
    author_email='support@controlplane.com',
    # License
    ...
    packages=['datadog_checks.controlplane'],
